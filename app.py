...
if files:
    for file in files:
        ...
        if st.checkbox(f"🔧 Fill Missing Values - {file.name}"):
            ...
            # 🔍 Select Specific Columns to Fill Missing Values
            selected_columns = st.multiselect(f"📊 Select columns to fill missing values - {file.name}", df.columns, default=df.columns)
